...
class wpc_simple_cdn {
	...
	static $directories_to_include;
	static $isAjax;
	static $homeUrl;
	static $siteUrl;
	static $isMultisite;

	static $lazyExcludedList;
	static $excludedList;
	static $defaultExcludedList;
	...
	public function reformatUrl( $url, $remove_site_url = false ) {
		...
		if ( $remove_site_url ) {
			...
			$formatted_url = str_replace( str_replace( array( 'https://', 'http://' ), '', $this->siteUrl ), '', $formatted_url );
