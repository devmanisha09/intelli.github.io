    ...
    public function register()
    {
        ...
        add_filter('fluentform_global_addons', function ($addons) use ($isEnabled) {
            $addons['zapier'] = [
                'title' => 'Zapier',
                'category' => 'crm',
                'description' => 'Fluent Forms Zapier module allows you to connect your WordPress forms with over 600+ web apps. The integration possibilities here are just endless.',
