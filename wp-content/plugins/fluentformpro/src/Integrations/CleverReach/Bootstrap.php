...
//        add_filter('fluentform_notifying_async_cleverreach', '__return_false');
        ...
        $this->description = 'CleverReach is web-based email marketing software for managing email campaigns and contacts. Use Fluent Forms to grow your CleverReach subscriber list.';
